...
config = "original_example_graph", "original_example_settings_energy_test",  43000.2
...
#config = "tarau2010_graph_original", "tarau2010_settings_regular", 9720000  # Original version (adapted)
...
command, command_args = "embedding_adversarial_search", "--input_eps_l_inf 6.4"
